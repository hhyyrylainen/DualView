...
public interface IDatabaseService : IDatabaseCommonService, IDisposable
{
    ...
    public Task<MediaFile?> GetMediaByIdIncludingDeletedAsync(long id);
    ...
    public Task<UploadSection?> GetUploadSectionAsync(long sectionId);
    public Task<UploadSection> CloneUploadSectionAsync(long sectionId);
